...
const listadoClientes = document.querySelector('#listado-clientes');
    ...
    function eliminar(e) {
        ...
        {
           const elim = Number(e.target.dataset.cliente);
           const conf = confirm("Desea Eliminar Este Dato?");
           if (conf)
           {
        const transaction = DB.transaction(['crm'],'readwrite');
        const objectStore = transaction.objectStore('crm');
        objectStore.delete(elim);
                ...
                //  console.log(e.target);
                 ...
                 if(cursor) {
                   x=x+1;
                    ...
                    document.querySelector('#mensaje').innerHTML=`Cantidad de Clientes en Lista ${x}`;
                    const listadoClientes = document.querySelector('#listado-clientes');
